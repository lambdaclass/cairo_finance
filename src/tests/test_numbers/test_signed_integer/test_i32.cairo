mod TestInteger32 {
    mod ConvertI32toU8 {
        ...
        use cairo_finance::numbers::signed_integer::i32::{i32, i32TryIntou8};
    ...
    mod ConvertU8toI32 {
        ...
        use cairo_finance::numbers::signed_integer::i32::{i32, u8Intoi32};
        use cairo_finance::numbers::signed_integer::integer_trait::IntegerTrait;
    ...
    mod ConvertI32toI16 {
        ...
        use cairo_finance::numbers::signed_integer::i32::{i32, i32TryIntoi16};
        use cairo_finance::numbers::signed_integer::integer_trait::IntegerTrait;
    ...
    mod ConvertI32toU32 {
        use cairo_finance::numbers::signed_integer::i32::{i32, i32TryIntou32};
        use cairo_finance::numbers::signed_integer::integer_trait::IntegerTrait;
        use integer::BoundedInt;
    ...
    mod ConvertI32toU128 {
        use cairo_finance::numbers::signed_integer::i32::{i32, i32TryIntou128};
        use cairo_finance::numbers::signed_integer::integer_trait::IntegerTrait;
        use integer::BoundedInt;
    ...
    mod ModI32 {
        use cairo_finance::numbers::signed_integer::i32::{i32, i32_mod};
        use cairo_finance::numbers::signed_integer::integer_trait::IntegerTrait;
        ...
        fn test_positive_mod() {
            ...
            assert(i32_mod(n, m) == IntegerTrait::<i32>::new(1, false), '1 mod 256 -> 1');
        }
        ...
        fn test_large_positive_mod() {
            ...
            let m = IntegerTrait::<i32>::new(256, false); // 256
            assert(i32_mod(n, m) == IntegerTrait::<i32>::new(1, false), '257 mod 256 -> 1');
        }
        ...
        fn test_negative_mod() {
            ...
            let m = IntegerTrait::<i32>::new(256, false); // 256
            assert(i32_mod(n, m) == IntegerTrait::<i32>::new(255, false), '-1 mod 256 -> 255');
        }
        ...
        fn test_large_negative_mod() {
            ...
            let m = IntegerTrait::<i32>::new(256, false); // 256
            assert(i32_mod(n, m) == IntegerTrait::<i32>::new(255, false), '-257 mod 256 -> 256');
        }
        ...
        fn test_zero_mod() {
            ...
            let m = IntegerTrait::<i32>::new(256, false); // 256
            assert(i32_mod(n, m) == IntegerTrait::<i32>::new(0, false), '0 mod 256 -> 0');
        }
        ...
        fn test_divisor_negative() {
            ...
            let result = i32_mod(n, m);
        }
    }

    mod i32DivNoRound {
        use cairo_finance::numbers::signed_integer::integer_trait::IntegerTrait;
        use cairo_finance::numbers::signed_integer::i32::{i32, i32_div_no_round};
